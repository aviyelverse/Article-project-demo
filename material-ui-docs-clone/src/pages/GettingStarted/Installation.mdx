...
>
  <img src={require("../../images/figma.svg")} alt="figma" />
</a>
<a
  href="https://mui.com/store/items/adobe-xd-react/"
  style="margin-left: 32px; margin-top: 8px; display: inline-block;"
>
  <img src={require("../../images/adobexd.svg")} />
</a>
<a
  href="https://mui.com/store/items/sketch-react"
  style="margin-left: 32px; margin-top: 8px; display: inline-block;"
>
  <img src={require("../../images/sketch.svg")} alt="Sketch" />
</a>

A set of reusable components for design tools is available, designed to match the React components and to help you craft great products:

- [Figma](https://mui.com/store/items/figma-react/): A large UI kit with over 600 handcrafted MUI components.
- [Adobe XD](https://mui.com/store/items/adobe-xd-react/): A large UI kit with over 600 handcrafted MUI components.
- [Sketch](https://mui.com/store/items/sketch-react/): A large UI kit with over 600 handcrafted MUI symbols.
